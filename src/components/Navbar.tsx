...
const NAV_LINKS = ["About", "Services", "Projects", "Careers", "News"];
    ...
    >
      ...
      >
        <a href="/" className="shrink-0">
          <img
            src="https://ashbardenergy.com/wp-content/uploads/2023/03/ashba.png"
            alt="Ashbard Energy"
          ...
          {NAV_LINKS.map((link) => (
            <li key={link}>
              <a
                ...
                className={`text-base font-medium transition-colors hover:text-red ${
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            className="hidden rounded-full bg-red px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-red-hover lg:inline-flex"
          >
            Contact Us
          </button>
        ...
        >
          <div className="flex items-start justify-between border-b border-white/10 pb-5">
            <div>
              ...
              <p className="mt-3 text-xl font-semibold text-white">Ashbard Energy</p>
              <p className="mt-1 text-xs text-white/60">Precision. Safety. Delivery.</p>
            </div>
            <button
              type="button"
              onClick={() => setMenuOpen(false)}
          ...
          <a
            href="#contact"
            onClick={() => setMenuOpen(false)}
            className="mt-6 inline-flex w-full items-center justify-center rounded-full bg-red px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-red/25 transition hover:bg-red-hover"
          >
            Contact Us
          </a>
          ...
          <div className="mt-4 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3">
            ...
            <a href="#" className="mt-2 block text-sm font-medium text-white/85">
